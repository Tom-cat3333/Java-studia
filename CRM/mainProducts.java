 ...
 * @author sasha
 */
public class mainProducts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAvatar.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nazwa", "Kod produktu", "Cena netto", "VAT (%)", "Cena brutto", "Stan magazynowy"
            }
        ) {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            jTable1.getColumnModel().getColumn(0).setMinWidth(590);
            jTable1.getColumnModel().getColumn(0).setPreferredWidth(635);
            jTable1.getColumnModel().getColumn(0).setMaxWidth(680);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mainProducts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mainProducts().setVisible(true);
            }
        });
    }

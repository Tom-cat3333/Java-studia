 ...
 * @author sasha
 */
public class mainOffers extends javax.swing.JFrame {

    /**
     * Creates new form mainOffers
     */
    public mainOffers() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 110, 1130, 700));
    ...
    public static void main(String args[]) {
        ...
        /* If Nimbus (introduced in JavabtnUserst available, stay with the default look and feel.
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mainOffers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mainOffers().setVisible(true);
            }
        });
    }
